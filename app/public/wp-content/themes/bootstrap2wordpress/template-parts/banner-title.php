...
<section class="title-banner">
    ...
    <div class="row">
        ...
        <?php
            ...
            //This will return the ID of the Page assigned to display the Blog Post Index
...
<section class="subscribe-bar">
    ...
    <div class="row flex-vertical-center">
        ...
        <p><?php echo wp_kses_post( get_theme_mod( 'subscribe_text', '<p><strong>Want to save 20% on the course?</strong> Enter you email and we\'ll send you the discount code!</p>' ) ); ?></p>
